 ...
 * @author     Hassan Barza <support@codnitive.com>
 */
class Codnitive_Frotel_Block_Checkout_Onepage_Shipping extends Mage_Checkout_Block_Onepage_Shipping
{
	...
	public function getCountryHtmlSelect($type)
	{
		...
		if ($type === 'shipping') {
			$select->setExtraParams('onchange="if(window.shipping)shipping.setSameAsBilling(false);Codnitive.frotel.flipFields(this, \'shipping\');"');
		}
